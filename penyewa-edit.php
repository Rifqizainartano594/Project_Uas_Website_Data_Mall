...
$query = "SELECT * FROM penyewa WHERE nik='$nik'";
...
if(isset($_POST['btn-ubah'])){
    ...
    $query = "UPDATE penyewa SET nama = '$nama', alamat = '$alamat', tanggal_lahir = '$tanggal', 
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <?php include_once("../layout/topbar.php") ?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Ubah Data Penyewa</h1>
