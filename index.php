                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <?php
                                                $datapenyewa = getList("SELECT count(nik) as jumlahSiswa FROM penyewa");
                                                 foreach ($datapenyewa as $row) {
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php
                                                $datatoko = getList("SELECT count(nik) as jumlahtoko FROM data_lapk");
