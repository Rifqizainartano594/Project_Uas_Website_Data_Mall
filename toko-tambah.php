...
if(isset($_POST['btn-simpan'])){
    ...
    $query = "INSERT INTO data_lapk VALUES ('$nik','$nama','$tanggal_awal','$tanggal_akhir','$lantai')";
            ...
            <?php include_once("../layout/topbar.php") ?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="text-center">
                        <button type="simpan" name="btn-simpan" class="btn btn-primary tambah">Simpan</button>
